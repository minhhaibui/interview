...
test('dashboard: panel Tư duy phủ ĐỦ mode trắc nghiệm kỹ thuật (kể cả java/redis/dist/devops)', () => {
  ...
  // Đánh dấu 🎯 mảng yếu nhất — khớp gợi ý ở tab Hôm nay (cùng weakestTechMode).
  assert.ok(/weakestTechMode\(\)/.test(statsBlock), 'panel Tư duy nên đánh dấu mảng yếu nhất qua weakestTechMode');
