...
- **🃏 Flashcards** — học từ vựng theo SRS (Leitner box), lọc theo tuần / đến hạn /
  ...
  **🎯 quiz chọn nghĩa** (hiện từ + phát âm → chọn nghĩa đúng trong 4, chấm ngay +
  cập nhật SRS) — cả hai chạy cho mọi ngôn ngữ.
  Bộ chọn **🌏 ngôn ngữ**: 🇬🇧 Anh · 🇰🇷 Hàn · 🇨🇳 Trung — Hàn/Trung mỗi thứ tiếng
  96 từ/cụm nhập môn theo 12 chủ đề (chào hỏi, số đếm, gia đình, ăn uống, thời gian,
  công việc, giao tiếp, nơi chốn, màu sắc, mua sắm, động từ, cảm xúc), kèm phiên âm
  (romanization/pinyin), câu ví dụ và **phát âm TTS đúng giọng bản ngữ**; SRS/từ cứng
  đầu dùng chung cơ chế.
