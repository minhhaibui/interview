...
- **🔎 Tìm kiếm toàn cục** — nút 🔎 topbar hoặc phím `/`: tìm khắp mọi ngân hàng câu
  hỏi (quiz trắc nghiệm · lập trình · sửa bug · thiết kế · STAR), **gõ không dấu vẫn
  khớp**; chọn câu trắc nghiệm → luyện ngay 1 câu, loại khác → mở đúng bài; kèm lối
  tắt tìm tiếp trong tài liệu.
