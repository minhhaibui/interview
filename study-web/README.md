...
- **🧠 Tư duy** — 12 chế độ:
  ...
  - 🧩 **IQ**, 🔍 **Đoán output**, ⏱️ **Độ phức tạp**, 📡 **API/HTTP**, 🗄️ **SQL**, 🖥️ **CLI**, ☕ **Java**, ☁️ **Redis**, 🏗️ **Phân tán**, 🐳 **DevOps**,
    ...
    📖 **Lý thuyết chuyên sâu JS · Node · React** (261 câu) — hỏi KHÁI NIỆM & CƠ CHẾ, không phải
    đoán output; **làm riêng** ở đây theo từng mảng, hoặc **làm chung** trong buổi 🎯 Phỏng vấn:
    🟨 **JavaScript** (93 câu): scope & hoisting/TDZ, closure, `this` & binding, prototype/class,
    ...
    và Service Worker.
    🟢 **Node.js** (86 câu): 6 pha event loop & libuv thread pool, `nextTick` vs `setImmediate`,
    ...
    versioning API, và thiết kế response lỗi.
    ⚛️ **React** (82 câu): virtual DOM & reconciliation, **key**, batching & bất biến, derived state,
    ...
    polling vs SSE vs WebSocket, và bản đồ vòng đời class → hooks.
...
- **🎯 Phỏng vấn** — một tab gộp cả buổi phỏng vấn, có 3 chế độ:
  ...
  ⌨️ code **110 câu** (đoán output 52 + Big-O 58), 📖 lý thuyết **261 câu**
  (JS 93 · Node 86 · React 82) — chạy được **~15 buổi liên tiếp** mà IQ, tiếng Anh và
