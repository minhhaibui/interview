...
- **🃏 Flashcards** — học từ vựng theo SRS (Leitner box), lọc theo tuần / đến hạn /
  từ hay sai; kèm chế độ **test gõ**: tiếng Anh gõ từ, tiếng Hàn/Trung **gõ phiên âm**
  (hiện chữ gốc → gõ romanization/pinyin, chấm bỏ dấu thanh điệu cho dễ).
  Bộ chọn **🌏 ngôn ngữ**: 🇬🇧 Anh · 🇰🇷 Hàn · 🇨🇳 Trung — Hàn/Trung mỗi thứ tiếng
  64 từ/cụm nhập môn theo 8 chủ đề (chào hỏi, số đếm, gia đình, ăn uống, thời gian,
  công việc, giao tiếp, nơi chốn), kèm phiên âm (romanization/pinyin), câu ví dụ
  và **phát âm TTS đúng giọng bản ngữ**; SRS/từ cứng đầu dùng chung cơ chế.
...
- **🧠 Tư duy** — 9 chế độ:
  ...
  - 🎓 **Thi thử** — bài kiểm tra tổng hợp **có tính giờ** mô phỏng screening test online
    (⚡ 10 câu·7 phút, 🎓 20 câu·15 phút bốc xen kẽ đều 6 mảng trắc nghiệm, hoặc
