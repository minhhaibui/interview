...
- **🃏 Flashcards** — học từ vựng theo SRS (Leitner box), lọc theo tuần / đến hạn /
  ...
  **🎯 quiz chọn nghĩa** (hiện từ + phát âm → chọn nghĩa đúng trong 4, chấm ngay +
  ...
  80 từ/cụm nhập môn theo 10 chủ đề (chào hỏi, số đếm, gia đình, ăn uống, thời gian,
  công việc, giao tiếp, nơi chốn, màu sắc, mua sắm), kèm phiên âm (romanization/pinyin),
  câu ví dụ và **phát âm TTS đúng giọng bản ngữ**; SRS/từ cứng đầu dùng chung cơ chế.
