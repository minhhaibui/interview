...
- **🧠 Tư duy** — 9 chế độ:
  ...
  - 🧩 **IQ**, 🔍 **Đoán output**, 📡 **API/HTTP**, 🗄️ **SQL**, 🖥️ **CLI**, ☕ **Java**, ☁️ **Redis**, 🏗️ **Phân tán** — trắc nghiệm có giải thích.
    ...
    ☁️ **Redis phỏng vấn**: kiểu dữ liệu, RDB/AOF, cache穿透/击穿/雪崩, khoá phân tán, HA.
    ...
    Spring/JPA (DI, bean scope, @Transactional, N+1).
