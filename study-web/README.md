...
- **🧠 Tư duy** — 8 chế độ:
  ...
  - 🔁 **Ôn câu sai** — gom mọi câu trắc nghiệm từng chọn sai (output/API/SQL/CLI +
    ...
    (đúng → rời hàng đợi); kèm 🎲 **Ôn trộn nhanh** bốc ngẫu nhiên mọi mode.
...
- **📊 Tiến độ** — heatmap hoạt động, phân bố SRS, biểu đồ, **Điểm sẵn sàng phỏng vấn**,
  và **🖨️ Bản in ôn nhanh** (cheat sheet cá nhân hoá: từ hay quên, câu đang sai kèm đáp án,
  ý chính các đề design yếu — in ra đọc trước giờ phỏng vấn).
