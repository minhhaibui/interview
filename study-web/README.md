...
- **🃏 Flashcards** — học từ vựng theo SRS (Leitner box), lọc theo tuần / đến hạn /
  ...
  **🎯 quiz chọn nghĩa** (hiện từ + phát âm → chọn nghĩa đúng trong 4, chấm ngay +
  ...
  128 từ/cụm nhập môn theo 16 chủ đề (chào hỏi, số đếm, gia đình, ăn uống, thời gian,
  công việc, giao tiếp, nơi chốn, màu sắc, mua sắm, động từ, cảm xúc, thời tiết, đi lại,
  cơ thể, quần áo),
