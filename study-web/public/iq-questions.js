...
{ id: 'nmath3', category: '➗ Toán nhanh', q: 'Nếu 3 máy làm xong việc trong 6 giờ, thì 6 máy (cùng tốc độ) làm xong trong?', options: ['2 giờ', '3 giờ', '4 giờ', '12 giờ'], answer: 1,
  ...
  { id: 's2-6', category: '🔢 Dãy số', d: 2, q: 'Số tiếp theo: 2, 6, 12, 20, 30, ?', options: ['36', '40', '42', '44'], answer: 2,
    explain: 'Khoảng cách tăng đều 4, 6, 8, 10, 12 ⇒ 30 + 12 = 42. (Cũng là n(n+1).)' },
  ...
  { id: 's2-9', category: '🔢 Dãy số', d: 1, q: 'Số tiếp theo: 81, 27, 9, 3, ?', options: ['0', '1', '1.5', '2'], answer: 1,
    explain: 'Mỗi số chia 3: 3 ÷ 3 = 1.' },
  ...
  { id: 's2-11', category: '🔢 Dãy số', d: 1, q: 'Số tiếp theo: 1, 8, 27, 64, ?', options: ['100', '125', '144', '216'], answer: 1,
    explain: 'Lập phương: 1³, 2³, 3³, 4³ ⇒ 5³ = 125.' },
  ...
  { id: 's2-13', category: '🔢 Dãy số', d: 1, q: 'Số tiếp theo: 1, 3, 6, 10, 15, ?', options: ['18', '20', '21', '25'], answer: 2,
    explain: 'Dãy tam giác, cộng thêm 2, 3, 4, 5, 6: 15 + 6 = 21.' },
  { id: 's2-14', category: '🔢 Dãy số', d: 2, q: 'Số tiếp theo: 5, 10, 7, 14, 11, ?', options: ['20', '22', '24', '28'], answer: 1,
    explain: 'Xen kẽ ×2 rồi −3: 11 × 2 = 22.' },
  { id: 's2-15', category: '🔢 Dãy số', d: 1, q: 'Số tiếp theo: 3, 9, 27, 81, ?', options: ['162', '216', '243', '324'], answer: 2,
    explain: 'Mỗi số nhân 3: 81 × 3 = 243.' },
  { id: 's2-16', category: '🔢 Dãy số', d: 1, q: 'Số tiếp theo: 1, 2, 4, 7, 11, 16, ?', options: ['20', '21', '22', '23'], answer: 2,
    explain: 'Khoảng cách tăng đều 1, 2, 3, 4, 5 ⇒ +6: 16 + 6 = 22.' },
  ...
  { id: 's2-23', category: '🔢 Dãy số', d: 1, q: 'Số tiếp theo: 1, 1, 2, 6, 24, ?', options: ['60', '96', '120', '144'], answer: 2,
    explain: 'Nhân dần ×1, ×2, ×3, ×4 ⇒ 24 × 5 = 120 (giai thừa).' },
  { id: 's2-24', category: '🔢 Dãy số', d: 2, q: 'Số tiếp theo: 2, 5, 10, 17, 26, ?', options: ['33', '35', '37', '39'], answer: 2,
    explain: 'Dãy n² + 1: 1+1, 4+1, 9+1, 16+1, 25+1 ⇒ 36 + 1 = 37.' },
  ...
  { id: 's2-26', category: '🔢 Dãy số', d: 1, q: 'Số tiếp theo: 10, 9, 7, 4, ?', options: ['0', '1', '2', '3'], answer: 0,
    explain: 'Trừ dần 1, 2, 3 ⇒ trừ 4: 4 − 4 = 0.' },
  ...
  // ---- 🔠 Chữ cái ----
  { id: 'l2-1', category: '🔠 Chữ cái', d: 1, q: 'Chữ tiếp theo: A, C, E, G, ?', options: ['F', 'H', 'I', 'J'], answer: 2,
    explain: 'Cách một chữ: A(1), C(3), E(5), G(7) ⇒ I(9).' },
  ...
  { id: 'l2-3', category: '🔠 Chữ cái', d: 1, q: 'Chữ tiếp theo: Z, X, V, T, ?', options: ['P', 'Q', 'R', 'S'], answer: 2,
    explain: 'Lùi 2 chữ mỗi bước: Z(26), X(24), V(22), T(20) ⇒ R(18).' },
  ...
  // ---- ➗ Toán nhanh ----
  { id: 'm2-1', category: '➗ Toán nhanh', d: 1, q: '15% của 200 là bao nhiêu?', options: ['20', '25', '30', '35'], answer: 2,
    explain: '10% là 20, 5% là 10 ⇒ 15% = 30.' },
  ...
  { id: 's2-44', category: '🔢 Dãy số', d: 2, q: 'Số tiếp theo: 3, 5, 9, 17, 33, ?', options: ['49', '57', '65', '73'], answer: 2,
    explain: 'Quy luật ×2 − 1: 33 × 2 − 1 = 65.' },
  ...
  { id: 'sq3-1', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 2, 12, 36, 80, ?', options: ['120', '150', '180', '200'], answer: 1,
    explain: 'Quy luật n² × (n+1): 1·2, 4·3, 9·4, 16·5, 25·6 = 150.' },
  ...
  { id: 'sq3-3', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 1, 4, 13, 40, ?', options: ['80', '104', '121', '160'], answer: 2,
    explain: 'Quy luật × 3 + 1: 40 × 3 + 1 = 121.' },
  ...
  // =========================================================================
  // ---- Nhân/cộng có hệ số ----
  { id: 'n6-1', category: '🔢 Dãy số', d: 2, q: 'Số tiếp theo: 3, 7, 15, 31, ?', options: ['47', '55', '63', '64'], answer: 2,
    explain: 'Quy luật × 2 + 1: 31 × 2 + 1 = 63 (cũng chính là 2ⁿ − 1: 4, 8, 16, 32, 64 trừ 1).' },
  { id: 'n6-2', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 5, 8, 14, 26, ?', options: ['38', '44', '50', '52'], answer: 2,
    explain: 'Quy luật × 2 − 2: 26 × 2 − 2 = 50.' },
  { id: 'n6-3', category: '🔢 Dãy số', d: 2, q: 'Số tiếp theo: 2, 5, 11, 23, ?', options: ['35', '46', '47', '48'], answer: 2,
    explain: 'Quy luật × 2 + 1: 23 × 2 + 1 = 47.' },
  { id: 'n6-4', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 1, 4, 10, 22, 46, ?', options: ['82', '90', '92', '94'], answer: 3,
    explain: 'Quy luật × 2 + 2: 46 × 2 + 2 = 94.' },
  { id: 'n6-5', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 3, 5, 9, 17, 33, ?', options: ['49', '63', '65', '66'], answer: 2,
    explain: 'Quy luật × 2 − 1: 33 × 2 − 1 = 65.' },
  // ---- Bước nhảy thay đổi ----
  ...
  { id: 'n6-8', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 120, 60, 20, 5, ?', options: ['1', '2', '2,5', '4'], answer: 0,
    explain: 'Chia lần lượt cho 2, 3, 4 rồi 5: 5 ÷ 5 = 1.' },
  { id: 'n6-9', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 1, 3, 12, 60, ?', options: ['180', '240', '300', '360'], answer: 3,
    explain: 'Nhân lần lượt với 3, 4, 5 rồi 6: 60 × 6 = 360.' },
  // ---- Theo công thức của n ----
  { id: 'n6-10', category: '🔢 Dãy số', d: 2, q: 'Số tiếp theo: 2, 5, 10, 17, 26, ?', options: ['35', '36', '37', '38'], answer: 2,
    explain: 'Quy luật n² + 1: 6² + 1 = 37.' },
  ...
  { id: 'n6-18', category: '🔢 Dãy số', d: 3, q: 'Số tiếp theo: 1, 2, 3, 6, 11, 20, ?', options: ['31', '35', '37', '40'], answer: 2,
    explain: 'Mỗi số bằng tổng BA số trước: 6 + 11 + 20 = 37.' },
  // ---- Hai dãy đan xen ----
