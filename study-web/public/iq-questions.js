...
{ id: 'nmath3', category: '➗ Toán nhanh', q: 'Nếu 3 máy làm xong việc trong 6 giờ, thì 6 máy (cùng tốc độ) làm xong trong?', options: ['2 giờ', '3 giờ', '4 giờ', '12 giờ'], answer: 1,
  ...
  // Ngược với "xoá một ô": THÊM đúng một ô
  figQ({
    id: 'add1', d: 2, q: 'Hình nào là hình mẫu bên dưới sau khi TÔ THÊM ĐÚNG MỘT ô?',
    fig: figRow([gSvg('110/010/000')]),
    opts: [gSvg('110/010/001'), gSvg('110/010/000'), gSvg('110/011/001'), gSvg('100/010/001')],
    explain: 'Đáp án phải giữ nguyên cả 3 ô của mẫu và tô thêm đúng 1 ô ⇒ tổng 4 ô, không được bớt ô nào.',
  }),
  { id: 'maxrow', category: '🖼️ Suy luận hình', d: 2, q: 'Trong bảng dưới đây, HÀNG nào có tổng số ô được tô nhiều nhất?',
    fig: figGrid([gSvg('110/000/000'), gSvg('100/000/000'), gSvg('111/000/000'),
      gSvg('111/000/000'), gSvg('110/000/000'), gSvg('111/000/000'),
      gSvg('100/000/000'), gSvg('110/000/000'), gSvg('100/000/000')]),
    options: ['Hàng 1', 'Hàng 2', 'Hàng 3', 'Ba hàng bằng nhau'], answer: 1,
    explain: 'Tổng số ô mỗi hàng: 2+1+3 = 6; 3+2+3 = 8; 1+2+1 = 4 ⇒ hàng 2 nhiều nhất.' },
  figQ({
    id: 'diagseq', d: 3, q: 'Hình tiếp theo của chuỗi là gì?',
    fig: figRow([gSvg('001/000/000'), gSvg('000/010/000'), gSvg('000/000/100'), '?']),
    opts: [gSvg('001/000/000'), gSvg('100/000/000'), gSvg('000/001/000'), gSvg('000/000/001')],
    explain: 'Ô tô chạy dọc ĐƯỜNG CHÉO PHỤ (trên-phải → tâm → dưới-trái); hết đường chéo thì QUAY VÒNG về đầu.',
  }),
  gOpQ('gx46', 2, '010/111/001', '110/011/010', 'and', 'Giao hai lưới: chỉ giữ ô cả hai cùng tô.'),
  { id: 'nm42', category: '🖼️ Suy luận hình', d: 3, q: 'Số ở ô dấu ? là bao nhiêu? (tổng CẢ BẢNG bằng 45)',
    fig: figGrid([numCell(2), numCell(7), numCell(6), numCell(9), numCell(5), numCell(1), numCell(4), numCell(3), '?'], 3),
    options: ['6', '8', '9', '10'], answer: 1,
    explain: 'Tổng 8 số đã cho là 37 ⇒ ô còn lại là 45 − 37 = 8 (bảng này chính là ma phương 3×3).' },
  { id: 'dl131', category: '🧠 Logic', d: 3, q: 'Trong 6 quả bóng có 1 quả nặng khác thường (chưa biết nặng hơn hay nhẹ hơn). Cần ít nhất mấy lần cân thăng bằng để CHẮC CHẮN tìm ra?', options: ['2', '3', '4', '5'], answer: 1,
    explain: 'Có 12 khả năng (6 quả × nặng/nhẹ); mỗi lần cân cho 3 kết quả nên 2 lần chỉ phân biệt được 9 ⇒ cần 3 lần.' },
  { id: 'dl132', category: '🧠 Logic', d: 2, q: 'Một sợi dây được gấp đôi 3 lần rồi cắt một nhát ở giữa. Được bao nhiêu đoạn?', options: ['4', '8', '9', '16'], answer: 2,
    explain: 'Gấp 3 lần được 8 lớp; cắt một nhát tạo 8 vết cắt trên sợi dây ⇒ 8 + 1 = 9 đoạn.' },
  { id: 'dl133', category: '➗ Toán nhanh', d: 2, q: 'Một đội chạy 6 sprint mỗi năm, mỗi sprint 3 tuần. Đội dành bao nhiêu tuần cho sprint trong năm?', options: ['12 tuần', '18 tuần', '24 tuần', '36 tuần'], answer: 1,
    explain: '6 × 3 = 18 tuần (khoảng một phần ba năm).' },
  { id: 'dl134', category: '🎲 Xác suất', d: 3, q: 'Ba lá thư và ba phong bì bị bỏ ngẫu nhiên. Xác suất KHÔNG lá nào đúng phong bì của nó là bao nhiêu?', options: ['1/6', '1/3', '1/2', '2/3'], answer: 1,
  ...
  figQ({
    id: 'parity1', d: 2, q: 'Hình nào có SỐ Ô ĐƯỢC TÔ là số LẺ?',
    opts: [gSvg('110/010/000'), gSvg('110/110/000'), gSvg('101/000/101'), gSvg('110/011/000')],
    explain: 'Ba hình kia tô 4 ô (số chẵn); chỉ một hình tô 3 ô — số lẻ.',
  }),
  figQ({
    id: 'alt180', d: 3, q: 'Hình tiếp theo của chuỗi là gì?',
    fig: figRow([gSvg('110/000/000'), gSvg('000/000/011'), gSvg('111/000/000'), gSvg('000/000/111'), '?']),
    opts: [gSvg('111/100/000'), gSvg('110/000/000'), gSvg('000/000/111'), gSvg('111/000/000')],
    explain: 'Chuỗi vừa XOAY 180° mỗi bước vừa thêm dần ô: 2, 2, 3, 3, 4 ô — bước thứ 5 quay lại phía trên với 4 ô.',
  }),
  figQ({
    id: 'sumcol1', d: 3, q: 'Ô dấu ? là hình nào? (số ô cột 3 = số ô cột 1 + cột 2)',
    fig: figGrid([gSvg('100/000/000'), gSvg('110/000/000'), gSvg('111/000/000'),
      gSvg('110/000/000'), gSvg('110/000/000'), gSvg('111/100/000'),
      gSvg('100/000/000'), gSvg('100/000/000'), '?']),
    opts: [gSvg('110/000/000'), gSvg('100/000/000'), gSvg('111/000/000'), gSvg('111/100/000')],
    explain: 'Hàng cuối: 1 ô + 1 ô = 2 ô ⇒ hình có đúng hai ô được tô.',
  }),
  gOpQ('gx48', 2, '110/010/011', '011/110/010', 'or', 'Hợp hai lưới: gộp mọi ô được tô của cả hai hình.'),
  { id: 'nm44', category: '🖼️ Suy luận hình', d: 3, q: 'Số ở ô dấu ? là bao nhiêu?',
    fig: figGrid([numCell(3), numCell(4), numCell(25), numCell(2), numCell(5), numCell(29), numCell(6), numCell(1), '?'], 3),
    options: ['7', '13', '37', '43'], answer: 2,
    explain: 'Cột 3 = cột 1² + cột 2²: 9 + 16 = 25, 4 + 25 = 29 ⇒ 36 + 1 = 37.' },
  { id: 'dl139', category: '🧠 Logic', d: 3, q: 'Một chiếc xe đi 60 km/h suốt nửa QUÃNG ĐƯỜNG đầu và 30 km/h nửa sau. Tốc độ trung bình cả chặng là bao nhiêu?', options: ['40 km/h', '42 km/h', '45 km/h', '50 km/h'], answer: 0,
    explain: 'Trung bình ĐIỀU HOÀ: 2 / (1/60 + 1/30) = 2 / (3/60) = 40 km/h (không phải 45).' },
  { id: 'dl140', category: '🧠 Logic', d: 2, q: 'Trong một phòng có 4 góc, mỗi góc có 1 con mèo, đối diện mỗi con mèo có 3 con mèo. Có bao nhiêu con mèo?', options: ['4', '8', '12', '16'], answer: 0,
    explain: 'Mỗi con nhìn thấy 3 con còn lại ⇒ vẫn chỉ có 4 con mèo.' },
  { id: 'dl141', category: '➗ Toán nhanh', d: 2, q: 'Một bảng có 500.000 dòng, mỗi lần phân trang lấy 25 dòng. Có bao nhiêu trang?', options: ['2.000', '10.000', '20.000', '25.000'], answer: 2,
    explain: '500.000 / 25 = 20.000 trang.' },
  { id: 'dl142', category: '🎲 Xác suất', d: 3, q: 'Có 4 chiếc chìa khoá, chỉ 1 chiếc mở được cửa. Thử ngẫu nhiên không lặp lại, xác suất mở được ở lần thử THỨ HAI là bao nhiêu?', options: ['1/4', '1/3', '1/2', '3/4'], answer: 0,
