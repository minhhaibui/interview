...
window.IQ_QUESTIONS = [
  ...
  { id: 'nseq1', category: '🔢 Dãy số', q: 'Số tiếp theo: 2, 6, 12, 20, 30, ?', options: ['36', '40', '42', '44'], answer: 2,
    explain: 'Hiệu tăng dần 4, 6, 8, 10, 12. 30 + 12 = 42 (cũng là n·(n+1): 6·7).' },
  { id: 'nseq2', category: '🔢 Dãy số', q: 'Số tiếp theo: 1, 3, 6, 10, 15, ?', options: ['18', '20', '21', '24'], answer: 2,
    explain: 'Số tam giác: cộng dần 2,3,4,5,6. 15 + 6 = 21.' },
  { id: 'nseq3', category: '🔢 Dãy số', q: 'Số tiếp theo: 81, 27, 9, 3, ?', options: ['0', '1', '2', '3'], answer: 1,
    explain: 'Chia 3 mỗi bước: 3 / 3 = 1.' },
  { id: 'nseq4', category: '🔢 Dãy số', q: 'Số tiếp theo: 2, 3, 5, 9, 17, ?', options: ['25', '31', '33', '34'], answer: 2,
    explain: 'Mỗi số = số trước ×2 trừ 1: 17×2−1 = 33.' },
  { id: 'nlog1', category: '🧠 Logic', q: 'Tất cả lập trình viên đều thích cà phê. An là lập trình viên. Suy ra?', options: ['An ghét cà phê', 'An thích cà phê', 'Không kết luận được', 'An không phải lập trình viên'], answer: 1,
    explain: 'Tam đoạn luận: mọi A là B, x là A ⇒ x là B.' },
  ...
  { id: 'nlog4', category: '🧠 Logic', q: 'Đố: "Cha của Bình có 5 con: Ca, Cô, Cu, Co, và ai?"', options: ['Ce', 'Bình', 'Ci', 'Cy'], answer: 1,
    explain: 'Người con thứ năm chính là Bình — câu đầu đã nói "cha của Bình".' },
  { id: 'nmath1', category: '➗ Toán nhanh', q: '15% của 200 là bao nhiêu?', options: ['25', '30', '35', '45'], answer: 1,
    explain: '10% = 20, 5% = 10, cộng lại = 30.' },
  { id: 'nmath2', category: '➗ Toán nhanh', q: 'Một áo giá 800k giảm 25%. Giá sau giảm?', options: ['550k', '600k', '640k', '700k'], answer: 1,
    explain: 'Giảm 25% còn 75%: 800k × 0.75 = 600k.' },
